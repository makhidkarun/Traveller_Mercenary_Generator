...
function generate_person_json( $rank_min, $rank_max, $role, $stat_parameters, $last_names, $male_first_names, $female_first_names, $rank_structure, $base_skills, $all_skills) {    
    global $mercenary_js;
	$upp = generate_stats($stat_parameters);
	$rank = $rank_structure[rand($rank_min, $rank_max)];
	$age = 18 + rand(0,5) + $rank_min; 
    ...
    $person_string = json_encode($person_array);
    fwrite($mercenary_js, $person_string);
    fwrite($mercenary_js, "\n");	
}

function generate_troops_json() {
    global $stat_parameters, $last_names, $male_first_names, $female_first_names, $rank_structure, $base_skills, $all_skills;

    for ( $i = 0; $i <100; $i++){
		generate_person_json( 10, 13, 'officer', $stat_parameters, $last_names, $male_first_names, $female_first_names, $rank_structure, $base_skills, $all_skills) ;
		generate_person_json( 14, 16, 'officer', $stat_parameters, $last_names, $male_first_names, $female_first_names, $rank_structure, $base_skills, $all_skills) ;
		generate_person_json( 5, 7, 'nco', $stat_parameters, $last_names, $male_first_names, $female_first_names, $rank_structure, $base_skills, $all_skills) ;
		generate_person_json( 4, 5, 'nco', $stat_parameters, $last_names, $male_first_names, $female_first_names, $rank_structure, $base_skills, $all_skills) ;
		generate_person_json( 2, 3, 'medic', $stat_parameters, $last_names, $male_first_names, $female_first_names, $rank_structure, $base_skills, $all_skills) ;
	    generate_person_json( 2, 3, 'comm', $stat_parameters, $last_names, $male_first_names, $female_first_names, $rank_structure, $base_skills, $all_skills) ;
	    generate_person_json( 2, 3, 'sensors', $stat_parameters, $last_names, $male_first_names, $female_first_names, $rank_structure, $base_skills, $all_skills) ;
	    generate_person_json( 2, 3, 'clerk', $stat_parameters, $last_names, $male_first_names, $female_first_names, $rank_structure, $base_skills, $all_skills) ;
	    generate_person_json( 1, 2, 'driver', $stat_parameters, $last_names, $male_first_names, $female_first_names, $rank_structure, $base_skills, $all_skills) ;
    }

    for ($i = 0; $i < 10000; $i++) {
		generate_person_json( 1, 1, 'troop', $stat_parameters, $last_names, $male_first_names, $female_first_names, $rank_structure, $base_skills, $all_skills) ;
    }
