...
//        }
//        $skill_line = $skill_line . "'$skill': $level";
//	}
//	echo "\n";
    $person_array = array(
        'rank' => $rank,
    ...
    fwrite($mercenary_js, "\n");
    // fwrite($mercenary_js,  "{ 'rank':'$rank', 'first_name': '$first_name', 'last_name':'$last_name', 'upp':'$upp', 'gender':'$gender', 'age':'$age',  'skills': { ");
 
//	echo "\n\t";
//    fwrite($mercenary_js, $skill_line);
